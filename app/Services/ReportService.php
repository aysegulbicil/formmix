...
class ReportService
{
    ...
    public function dashboard(): array
    {
        ...
        return [
            ...
            'openOrderCount' => count(array_filter($orders, static fn ($row) => in_array($row['status'], ['draft', 'approved', 'procurement_waiting', 'reserved', 'partially_shipped'], true))),
    ...
    {
        $labels = ['draft' => 'Tamamlanacak taslak', 'approved' => 'Sipariş oluşturuldu', 'procurement_waiting' => 'Hazırlanıyor', 'reserved' => 'Stok ayrıldı', 'partially_shipped' => 'Kısmi sevk'];
